...
public class RedisConfig {
    ...
    public CacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        // Course listings cache - 30 minutes
        cacheConfigurations.put("courses", defaultConfig.entryTtl(Duration.ofMinutes(30)));
        
        // Popular courses cache - 1 hour
        cacheConfigurations.put("popularCourses", defaultConfig.entryTtl(Duration.ofHours(1)));
